...
//array_push($arr, 132808730606);
//array_push($arr, 7713076301);
//array_push($arr, 7707083893);
...
$url = "https://script.google.com/macros/s/AKfycbw4koAEJ-JzGymWt34S5Y2es_CCoBJGcipANANz5jK9BixAD896y4sUIPi8GEuMW8Ae/exec?p1=$method_delivery&p2=$from_city&p3=$to_city&p4=$address_client_from&p5=$address_client_to&p6=$date_from&p7=$date_to&p8=$from_addr_time_from&p9=$from_addr_time_until&p10=$to_addr_time_from&p11=$to_addr_time_until&p12=$kilos&p13=$meters&p14=$pieces&p15=$heaviest&p16=$longest&p17=$term_trans&p18=$from_term_to_addr&p19=$from_addr_to_term&p20=$rigid&p21=$stretch&p22=$bort&p23=$ins&p24=$prr_at_addr&p25=$prr_to_addr&p26=$worth&p27=$compSender&p28=$FIOsender&p29=$Telsender&p30=$Emailsender&p31=$compReceiver&p32=$FIOreceiver&p33=$Telreceiver&p34=$Emailreceiver&p35=$comp3dparty&p36=$FIO3dparty&p37=$Tel3dparty&p38=$Email3dparty&p39=$who_pays_all&p40=$who_pays_term_transfer&p41=$who_pays_from_term_to_addr&p42=$who_pays_from_addr_to_term&p43=$who_pays_pac&p44=$who_pays_ins&p45=$who_pays_prr_at_addr&p46=$who_pays_prr_to_addr&p47=$total";
